...
class StartLocationPageWidget extends StatefulWidget {
  const StartLocationPageWidget({Key? key}) : super(key: key);

  static const routeName = '/StartLocationPage';
  @override
                      ...
                      child: FFButtonWidget(
                        onPressed: () async {
                          try {
                            ...
                            LocationDetails startLocationDetails =
                                LocationDetails(fAddr, lat1, lon1);

                            Navigator.pop(context, startLocationDetails);
                          } catch (e) {
                            setState(() {
                              isChecking = false;
                            });
